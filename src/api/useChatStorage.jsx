...
export default function useLocalStorage() {
    ...
    useEffect(() => {
        setIsLoaded(
            ...
            nameToIndexMap[conversationName] !== undefined
        );
    ...
    let saveConversationList = (content) => (async () => { await LocalStorage.setItem(NAMES.CONV, JSON.stringify(content)) })()
    let saveConversationName = (name) => (async () => { await LocalStorage.setItem(NAMES.CONV_NAME, name) })()
